...
<body>
	...
	<?php $query = mysqli_query($con, "SELECT * from tbltourpackages order by rand() limit 4");
	...
	<div style="float:right"><a href="package-list.php" class="button">View More Packages</a></div>
