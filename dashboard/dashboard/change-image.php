            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Update Package Image</h1>
                        </div>
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) {    ?>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <img src="../admin/pacakgeimages/<?php echo htmlentities($result->PackageImage); ?>" width="200">
                                                        </div>
                                                    </div>
